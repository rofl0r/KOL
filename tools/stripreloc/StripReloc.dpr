...

{
  ...
  Copyright (C) 2000-2003 Jordan Russell. All rights reserved.

  www:    http://www.jrsoftware.org/
  email:  jr AT jrsoftware.org
...
begin
  try
    Writeln('StripReloc v' + Version + ', Copyright (C) 2000-2003 Jordan Russell, www.jrsoftware.org');

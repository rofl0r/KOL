...
type
  ...
  protected
    FBccList: PIdEmailAddressList;
    FBody: PStrList;
    FCharSet: string;
    FCcList: PIdEmailAddressList;
    FContentType: string;
    FContentTransferEncoding: string;
    FDate: TDateTime;
    FIsEncoded: Boolean;
    FExtraHeaders: PIdHeaderList;
    FFrom: PIdEmailAddressItem;
    FHeaders: PIdHeaderList;
    FMessageParts: pIdMessageParts;
    FMsgId: string;
    ...
    FSubject: string;
    FReceiptRecipient: PIdEmailAddressItem;
    FRecipients: PIdEmailAddressList;
    FReferences: string;
    FReplyTo: PIdEmailAddressList;
    FSender: PIdEMailAddressItem;
    FXProgram: string;
  public
    ...
    property Headers: PIdHeaderList read FHeaders;
    property MessageParts: pIdMessageParts read FMessageParts;
   { published } 
    property Body: PStrList read FBody write SetBody;
    property BccList: PIdEmailAddressList read FBccList write FBccList;
    property CharSet: string read FCharSet write FCharSet;
    property CCList: PIdEmailAddressList read FCcList write FCcList;
    property ContentType: string read FContentType write FContentType;
    property ContentTransferEncoding: string read FContentTransferEncoding
    write FContentTransferEncoding;
    property Date: TDateTime read FDate write FDate;

    property ExtraHeaders: PIdHeaderList read FExtraHeaders write
      SetExtraHeaders;
    property From: PIdEmailAddressItem read FFrom write FFrom;
    ...
    property Priority: TIdMessagePriority read FPriority write FPriority default
      ID_MSG_PRIORITY;
    property ReceiptRecipient: PIdEmailAddressItem read FReceiptRecipient write
      FReceiptRecipient;
    property Recipients: PIdEmailAddressList read FRecipients write FRecipients;
    property References: string read FReferences write FReferences;
    property ReplyTo: pIdEmailAddressList read FReplyTo write FReplyTo;
    property Subject: string read FSubject write FSubject;
    property Sender: pIdEmailAddressItem read FSender write FSender;
...
begin
  FBody := NewStrList;
  FRecipients := NewdIdEMailAddressList(Result);
  FBccList :=    NewdIdEmailAddressList(Result);
  FCcList := NewdIdEmailAddressList(Result);
  FMessageParts := NewIdMessageParts(Result);
  FNewsGroups := NewStrList;
  FHeaders := NewIdHeaderList;
  FFrom := NewdIdEmailAddressItem;
  FReplyTo := NewdIdEmailAddressList(Result);
  FSender := NewdIdEmailAddressItem;
  FExtraHeaders := NewIdHeaderList;
  FReceiptRecipient := NewdIdEmailAddressItem;
...
procedure TIdMessage.SetExtraHeaders(const Value: pIdHeaderList);
begin
...
function TIdMessage.GenerateHeader: pIdHeaderList;
var
  MimeCharset: string;
  HeaderEncoding: Char;
...
//    Values['Newsgroups'] := NewsGroups.CommaText; {do not localize}
    ...
    Values['X-Priority'] := Int2Str(Ord(Priority) + 1); {do not localize}

{
       ...
       Unit: KolAsio
    purpose: ASIO Stream support for KOL
...
function ASIOSamplesToI64(const samples: TAsioInt64): I64;
...
function ASIOSamplesToI64(const samples: TAsioSamples): I64;
begin
  Result.Hi:=samples.hi;
  Result.Lo:=samples.lo;
end;

...
// File generated on 2002-06-20 21:16:04 from Type Library described below.
...
// *********************************************************************//
  TAgentActivateInput = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentDeactivateInput = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentClick = procedure(Sender: PObj; const CharacterID: WideString; Button: Smallint; 
                                           Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDblClick = procedure(Sender: PObj; const CharacterID: WideString; Button: Smallint; 
                                              Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDragStart = procedure(Sender: PObj; const CharacterID: WideString; Button: Smallint; 
                                               Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentDragComplete = procedure(Sender: PObj; const CharacterID: WideString; Button: Smallint; 
                                                  Shift: Smallint; x: Smallint; y: Smallint) of object;
  TAgentShow = procedure(Sender: PObj; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentHide = procedure(Sender: PObj; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentRequestStart = procedure(Sender: PObj; const Request: IDispatch) of object;
  TAgentRequestComplete = procedure(Sender: PObj; const Request: IDispatch) of object;
  TAgentBookmark = procedure(Sender: PObj; BookmarkID: Integer) of object;
  TAgentCommand = procedure(Sender: PObj; const UserInput: IDispatch) of object;
  TAgentIdleStart = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentIdleComplete = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentMove = procedure(Sender: PObj; const CharacterID: WideString; x: Smallint; y: Smallint; 
                                          Cause: Smallint) of object;
  TAgentSize = procedure(Sender: PObj; const CharacterID: WideString; Width: Smallint; 
                                          Height: Smallint) of object;
  TAgentBalloonShow = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentBalloonHide = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentHelpComplete = procedure(Sender: PObj; const CharacterID: WideString; 
                                                  const Name: WideString; Cause: Smallint) of object;
  TAgentListenStart = procedure(Sender: PObj; const CharacterID: WideString) of object;
  TAgentListenComplete = procedure(Sender: PObj; const CharacterID: WideString; Cause: Smallint) of object;
  TAgentDefaultCharacterChange = procedure(Sender: PObj; const GUID: WideString) of object;
  TAgentActiveClientChange = procedure(Sender: PObj; const CharacterID: WideString; 
                                                        Active: WordBool) of object;

  PAgent = ^TAgent;
  TAgent = object(TOleCtl)
  private
    FOnActivateInput: TAgentActivateInput;
    FOnDeactivateInput: TAgentDeactivateInput;
    FOnClick1: TAgentClick;
    ...
    FOnAgentPropertyChange: TOnEvent;
  ...
  //  published
    ...
    property OnClick: TAgentClick read FOnClick1 write FOnClick1;
    ...
    property OnShow: TAgentShow read FOnShow1 write FOnShow1;
    property OnHide: TAgentHide read FOnHide1 write FOnHide1;
    ...
    property OnRestart: TOnEvent read FOnRestart write FOnRestart;
    property OnShutdown: TOnEvent read FOnShutdown write FOnShutdown;
    ...
    property OnMove1: TAgentMove read FOnMove1 write FOnMove1;
    ...
    property OnAgentPropertyChange: TOnEvent read FOnAgentPropertyChange write FOnAgentPropertyChange;

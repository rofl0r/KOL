...
type
  ...
  TThemeServices = object(TObj)
  private
    FNewComCtrls,
    FThemesAvailable,
    FUseThemes: Boolean;
    FThemeData: TThemeData;
    FOnThemeChange: TOnEvent;//TNotifyEvent;
  ...
  public
     ...
     virtual; procedure ApplyThemeChange;
    ...
    procedure PaintBorder(Control: PControl{TWinControl}; EraseLRCorner: Boolean);
    ...
    property OnThemeChange: TOnEvent{TNotifyEvent} read FOnThemeChange write FOnThemeChange;
  end;
PThemeServices=^TThemeServices; type  MyStupid0=DWord;

//  TThemeServicesClass = object (TObj)of TThemeServices;

function ThemeServices: PThemeServices;//TThemeServices;
...
var
  InternalServices: PThemeServices;//TThemeServices;
...
function NewThemeServices:PThemeServices;
...
begin
  if InternalServices = nil then
    InternalServices := NewThemeServices; //ThemeServicesClass.Create;
...
procedure TThemeServices.DrawEdge(DC: HDC; Details: TThemedElementDetails;
  const R: TRect; Edge, Flags: Cardinal; AContentRect: PRect = nil);
begin
  with Details do
...
procedure TThemeServices.PaintBorder(Control: PControl{TWinControl}; EraseLRCorner: Boolean);
var
  EmptyRect,
  DrawRect: TRect;
  DC: HDC;

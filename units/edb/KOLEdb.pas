...
begin
  ...
  if CheckOLE( ADataSource.fIDBInitialize.QueryInterface( IID_IDBCreateSession, CreateSession ) ) then
...
begin
  ...
  case ColType[ Idx ] of
  ftReal:     Result := Double2Str( RField[ Idx ] );

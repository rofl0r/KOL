...
const
  Win: array[0..3, 0..35] of single = ((-1.6141214951E-02, - 5.3603178919E-02,
    - 1.0070713296E-01, - 1.6280817573E-01, - 4.9999999679E-01,
    - 3.8388735032E-01, - 6.2061144372E-01, - 1.1659756083E+00,
    - 3.8720752656E+00, - 4.2256286556E+00, - 1.5195289984E+00,
    - 9.7416483388E-01, - 7.3744074053E-01, - 1.2071067773E+00,
    - 5.1636156596E-01, - 4.5426052317E-01, - 4.0715656898E-01,
    - 3.6969460527E-01, - 3.3876269197E-01, - 3.1242222492E-01,
    - 2.8939587111E-01, - 2.6880081906E-01, - 5.0000000266E-01,
    - 2.3251417468E-01, - 2.1596714708E-01, - 2.0004979098E-01,
    - 1.8449493497E-01, - 1.6905846094E-01, - 1.5350360518E-01,
    - 1.3758624925E-01, - 1.2103922149E-01, - 2.0710679058E-01,
    - 8.4752577594E-02, - 6.4157525656E-02, - 4.1131172614E-02, - 1.4790705759E-02),

    (-1.6141214951E-02, - 5.3603178919E-02, - 1.0070713296E-01,
    - 1.6280817573E-01, - 4.9999999679E-01, - 3.8388735032E-01,
    - 6.2061144372E-01, - 1.1659756083E+00, - 3.8720752656E+00,
    - 4.2256286556E+00, - 1.5195289984E+00, - 9.7416483388E-01,
    - 7.3744074053E-01, - 1.2071067773E+00, - 5.1636156596E-01,
    - 4.5426052317E-01, - 4.0715656898E-01, - 3.6969460527E-01,
    - 3.3908542600E-01, - 3.1511810350E-01, - 2.9642226150E-01,
    - 2.8184548650E-01, - 5.4119610000E-01, - 2.6213228100E-01,
    - 2.5387916537E-01, - 2.3296291359E-01, - 1.9852728987E-01,
    - 1.5233534808E-01, - 9.6496400054E-02, - 3.3423828516E-02,
    0.0000000000E+00, 0.0000000000E+00,
    0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00),

    (-4.8300800645E-02, - 1.5715656932E-01, - 2.8325045177E-01,
    - 4.2953747763E-01, - 1.2071067795E+00, - 8.2426483178E-01,
    - 1.1451749106E+00, - 1.7695290101E+00, - 4.5470225061E+00,
    - 3.4890531002E+00, - 7.3296292804E-01, - 1.5076514758E-01,
    0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
    0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
    0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
    0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
    ...
    (0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00, 0.0000000000E+00,
    0.0000000000E+00, 0.0000000000E+00, - 1.5076513660E-01,
    - 7.3296291107E-01, - 3.4890530566E+00, - 4.5470224727E+00,
    - 1.7695290031E+00, - 1.1451749092E+00, - 8.3137738100E-01,
    - 1.3065629650E+00, - 5.4142014250E-01, - 4.6528974900E-01,
    - 4.1066990750E-01, - 3.7004680800E-01, - 3.3876269197E-01,
    - 3.1242222492E-01, - 2.8939587111E-01, - 2.6880081906E-01,
    - 5.0000000266E-01, - 2.3251417468E-01, - 2.1596714708E-01,
    - 2.0004979098E-01, - 1.8449493497E-01, - 1.6905846094E-01,
    - 1.5350360518E-01, - 1.3758624925E-01, - 1.2103922149E-01,
    - 2.0710679058E-01, - 8.4752577594E-02, - 6.4157525656E-02,
    - 4.1131172614E-02, - 1.4790705759E-02));
...
begin
  ...
  begin
    ...
    tmp0 := i0p12 + input[4] * 1.8793852415718 + input[8] * 1.532088886238 +
      input[16] * 0.34729635533386;
    tmp1 := i0 + input[4] - input[8] - input[12] - input[12] - input[16];
    tmp2 := i0p12 - input[4] * 0.34729635533386 - input[8] *
      1.8793852415718 + input[16] * 1.532088886238;
    tmp3 := i0p12 - input[4] * 1.532088886238 + input[8] * 0.34729635533386 -
      input[16] * 1.8793852415718;
    tmp4 := input[0] - input[4] + input[8] - input[12] + input[16];

    // 4 points on even indices
    i6_ := input[6] * 1.732050808;    // Sqrt[3]

    tmp0_ := input[2] * 1.9696155060244 + i6_ + input[10] * 1.2855752193731 +
      input[14] * 0.68404028665134;
    tmp1_ := (input[2] - input[10] - input[14]) * 1.732050808;
    tmp2_ := input[2] * 1.2855752193731 - i6_ - input[10] *
      0.68404028665134 + input[14] * 1.9696155060244;
    tmp3_ := input[2] * 0.68404028665134 - i6_ + input[10] *
      1.9696155060244 - input[14] * 1.2855752193731;
    ...
    tmp0o := i0p12 + input[4 + 1] * 1.8793852415718 + input[8 + 1] *
      1.532088886238 + input[16 + 1] * 0.34729635533386;
    tmp1o := i0 + input[4 + 1] - input[8 + 1] - input[12 + 1] - input[12 + 1]
      - input[16 + 1];
    tmp2o := i0p12 - input[4 + 1] * 0.34729635533386 - input[8 + 1] *
      1.8793852415718 + input[16 + 1] * 1.532088886238;
    tmp3o := i0p12 - input[4 + 1] * 1.532088886238 + input[8 + 1] *
      0.34729635533386 - input[16 + 1] * 1.8793852415718;
    tmp4o := (input[0 + 1] - input[4 + 1] + input[8 + 1] - input[12 + 1] + input[16 + 1]) *
      0.707106781;  // Twiddled

    // 4 points on even indices
    i6_ := input[6 + 1] * 1.732050808;  // Sqrt[3]

    tmp0_o := input[2 + 1] * 1.9696155060244 + i6_ + input[10 + 1] *
      1.2855752193731 + input[14 + 1] * 0.68404028665134;
    tmp1_o := (input[2 + 1] - input[10 + 1] - input[14 + 1]) * 1.732050808;
    tmp2_o := input[2 + 1] * 1.2855752193731 - i6_ - input[10 + 1] *
      0.68404028665134 + input[14 + 1] * 1.9696155060244;
    tmp3_o := input[2 + 1] * 0.68404028665134 - i6_ + input[10 + 1] *
      1.9696155060244 - input[14 + 1] * 1.2855752193731;

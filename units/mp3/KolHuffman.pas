...
function HuffmanDecoder(h: PHuffCodeTab; var x, y, v, w: integer;
  br: PBitReserve): integer;
...
const
  ...
  ValTab0: array[0..0] of THTArray = ((0,0));  // dummy

  ValTab1: array[0..6] of THTArray = ((2,1), (0,0), (2,1), (0,16), (2,1), (0,1), (0,17));

  ValTab2: array[0..16] of THTArray = ((2,1), (0,0), (4,1), (2,1),
    (0,16), (0,1), (2,1), (0,17), (4,1), (2,1),
    (0,32), (0,33), (2,1), (0,18), (2,1), (0,2), (0,34));

  ValTab3: array[0..16] of THTArray = ((4,1), (2,1), (0,0), (0,1),
    (2,1), (0,17), (2,1), (0,16), (4,1), (2,1),
    (0,32), (0,33), (2,1), (0,18), (2,1), (0,2), (0,34));

  ValTab4: array[0..0] of THTArray = ((0,0));  // dummy

  ValTab5: array[0..30] of THTArray = ((2,1), (0,0), (4,1), (2,1),
    (0,16), (0,1), (2,1), (0,17), (8,1), (4,1),
    (2,1), (0,32), (0,2), (2,1), (0,33), (0,18), (8,1), (4,1), (2,1), (0,34),
    (0,48), (2,1), (0,3), (0,19), (2,1), (0,49), (2,1), (0,50), (2,1), (0,35),
    (0,51));

  ValTab6: array[0..30] of THTArray = ((6,1), (4,1), (2,1), (0,0),
    (0,16), (0,17), (6,1), (2,1), (0,1), (2,1),
    (0,32), (0,33), (6,1), (2,1), (0,18), (2,1), (0,2), (0,34), (4,1), (2,1),
    (0,49), (0,19), (4,1), (2,1), (0,48), (0,50), (2,1), (0,35), (2,1), (0,3),
    (0,51));

  ValTab7: array[0..70] of THTArray = ((2,1), (0,0), (4,1), (2,1),
  ...
  ValTab8: array[0..70] of THTArray = ((6,1), (2,1), (0,0), (2,1),
    (0,16), (0,1), (2,1), (0,17), (4,1), (2,1),
  ...
  ValTab9: array[0..70] of THTArray = ((8,1), (4,1), (2,1), (0,0),
  ...
  ValTab10: array[0..126] of THTArray = ((2,1), (0,0), (4,1), (2,1),
  ...
  ValTab11: array[0..126] of THTArray = ((6,1), (2,1), (0,0), (2,1),
    (0,16), (0,1), (8,1), (2,1), (0,17), (4,1),
  ...
  ValTab12: array[0..126] of THTArray = ((12,1), (4,1), (2,1), (0,16),
    (0,1), (2,1), (0,17), (2,1), (0,0), (2,1),
  ...
  ValTab13: array[0..510] of THTArray = ((2,1), (0,0), (6,1), (2,1),
  ...
  ValTab14: array[0..0] of THTArray = ((0,0));  // dummy

  ValTab15: array[0..510] of THTArray = ((16,1), (6,1), (2,1), (0,0),
  ...
  ValTab16: array[0..510] of THTArray = ((2,1), (0,0), (6,1), (2,1),
  ...
  ValTab24: array[0..511] of THTArray = ((60,1), (8,1), (4,1), (2,1),
...
begin
  ...
  if (h.tablename[0] = '3') and ((h.tablename[1] = '2') or (h.tablename[1] = '3')) then 
  begin
    v := (y shr 3) and 1;
    w := (y shr 2) and 1;
    x := (y shr 1) and 1;
...
procedure SetHuffTable(ht: PHuffCodeTab; Name: PChar;
  xlen, ylen, linbits, linmax, ref: integer;

...
function Newreate (AnOwner: TIdTrivialFTPServer; const Mode: TIdTFTPMode;
      const PeerInfo: TPeerInfo;
      AStream: TStream; const FreeStreamOnTerminate: boolean; const
        RequestedBlockSize: Integer = 0):Preate;destructor Destroy; 
   virtual; end;
...
function NewIdTrivialFTPServer (axOwner: TComponent):PIdTrivialFTPServer;begin
  inherited;
...
function NewIdTFTPServerThread (AnOwner: TIdTrivialFTPServer;
  const Mode: TIdTFTPMode; const PeerInfo: TPeerInfo;
  AStream: TStream; const FreeStreamOnTerminate: boolean; const
    RequestedBlockSize: Integer):PIdTFTPServerThread;begin

Sharing of PStrList between different KOL applicationst with mirror.
By Alexander Shakhaylo, alex_s@kcci.kharkov.ua

INSTALLATION
1. Unpack where You wish preserving ralative pathes.
2. Create package (e.g. KOLMAPMEMPAK.DPK), add mckMapMem.pas there.

{******************************************************************}
{          MD5 Hashsum Evaluation Unit For Borland Delphi and KOL  }
{          Translation for KOL © 2003 Thaddy de Koning             }
{          E-mail:  thaddy@yhaddy.com                              }
{          Original Delphi version Copyright © 2002 by Dimka Maslov}
...
//Assembler written by Thaddy de Koning, works OK
//asm
//  xor ecx,edx;
//  xor eax,ecx;
end;
...
function ROTATE_LEFT(x:uint4; n:word): UINT4;
begin
...
begin
 Result:='';
 for i:=0 to 15 do Result:=Result+Int2Hex(Digest.v[i], 2);
end;

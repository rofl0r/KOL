...
type
  TTnCnx = object(TObj);
PTnCnx=^TTnCnx; type  MyStupid0=DWord; 
  ...
  public
     ...
     virtual; function    Send(Data : Pointer; Len : Integer) : integer;
...
PTnCnx=^TTnCnx;
function NewTnCnx(AOwner: TComponent):PTnCnx; type  MyStupid3137=DWord; 

...
PLine=^TLine; type  MyStupid0=DWord; 
  ...
  public
    ...
    FOnCursorVisible : TNotifyEvent;
     ...
     virtual; procedure   AdjustFLines(NewCount : Integer);
...
PScreen=^TScreen; type  MyStupid3137=DWord; 
  ...
  TCustomEmulVT = object(TCustomControl)
  private
...
Pcreen=^Screen;
function Newcreen(AOwner: TComponent):Pcreen; type  MyStupid86104=DWord; 

  { Same as TCustomEmulVT, but with published properties }
  TEmulVT = object(TCustomEmulVT)
  public
...
Preen=^creen; type  MyStupid20258=DWord; 

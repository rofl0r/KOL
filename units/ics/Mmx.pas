...
type
  TCpuId = ( cpuOld486, cpuNew486, cpuMMX, cpuSSE, cpuSSE2 );
...
var I: Integer;
begin
  Result := cpuOld486;                 // old 486 and earlier
  I := 0;
  ...
  Inc( Result );                       // MMX supported.
  if (I and (1 shl 25)) = 0 then Exit;
  Inc( Result );                       // SSE supported.
  if (I and (1 shl 26)) = 0 then Exit;
  Inc( Result );                       // SSE2 supported.
end;

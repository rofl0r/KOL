...
type
    ...
    NntpException = object(Exception);
PntpException=^NntpException; type  MyStupid0=DWord; 

    TNntpCli = object(TObj)
    public
...
PtpException=^ntpException;
function NewtpException(AOwner: TComponent):PtpException; type  MyStupid3137=DWord; 
...
function NewNntpCli (AOwner: TComponent):PNntpCli;begin

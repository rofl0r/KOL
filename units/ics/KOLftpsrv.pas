...
type
    PBoolean = ^Boolean;
    FtpServerException  = object(Exception);
PtpServerException=^FtpServerException; type  MyStupid0=DWord; 
...
{$IFDEF VER80}
    ...
    LPARAM = DWORD;
{$ENDIF}
    TFtpCtrlSocketClass = object (TObj)of TFtpCtrlSocket;
...
PFtpCtrlSocketClass=^TFtpCtrlSocketClass; type  MyStupid3137=DWord; 
    TFtpServer = object(TObj)
    protected
        FAddr                   : String;
        FPort                   : String;
        FBanner                 : String;
...
PtpCtrlSocketClass=^FtpCtrlSocketClass;
function NewtpCtrlSocketClass(AOwner: TComponent):PtpCtrlSocketClass; type  MyStupid86104=DWord; 

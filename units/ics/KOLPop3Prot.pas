...
type
    Pop3Exception = object(Exception);
Pop3Exception=^Pop3Exception; type  MyStupid0=DWord; 
    ...
    public
         ...
         virtual; procedure   Connect; virtual;
...
PCustomPop3Cli=^TCustomPop3Cli;
function NewCustomPop3Cli(AOwner : TComponent):PCustomPop3Cli; type  MyStupid3137=DWord; 

    TPop3Cli = object(TCustomPop3Cli)
     { published } 
        property Host;
...
PustomPop3Cli=^CustomPop3Cli; type  MyStupid86104=DWord; 
...
PstomPop3Cli=^ustomPop3Cli;
function NewstomPop3Cli(AOwner : TComponent):PstomPop3Cli; type  MyStupid20258=DWord; 

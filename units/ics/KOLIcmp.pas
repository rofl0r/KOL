...
uses
  Windows, SysUtils, Classes, WinSock, kol;
...
type
  ...
  TICMPDisplay = procedure(Sender: PObj; Msg : String) of object;
  TICMPReply   = procedure(Sender: PObj; Error : Integer) of object;
...
//    constructor Create; virtual;
    ...
    property OnEchoRequest : TOnEvent   read  FOnEchoRequest
